...
html_title = 'Rackspace product v# API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace product v# API'
...
latex_documents = [
  (master_doc, 'reponame.tex',
   'Rackspace product API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Product API documentation',
...
texinfo_documents = [
  (master_doc, 'reponame', 'Rackspace Product API Documentation',
   'Rackspace', 'reponame', 'Learn about using the Product',
   'Miscellaneous'),
]
